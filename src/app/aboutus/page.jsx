...
export const metadata = {
    title: 'Nosotros | Tu Socio en Transformación Digital',
    description: 'Somos un equipo de desarrolladores, diseñadores y expertos en SEO apasionados por crear soluciones digitales que marcan la diferencia. Conocé nuestra historia y valores.',
    keywords: 'nosotros agencia de software, equipo de desarrollo, desarrolladores web, expertos en SEO, diseñadores UX/UI, innovación tecnológica, transformación digital'
}
